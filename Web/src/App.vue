  ...
  <div>
    <ul>
      <li>
        ...
        <Dialog v-model:visible="visibleCreate" modal header="Create" :style="{ width: '25rem' }">
          ...
          <div class="flex items-center gap-4 mb-4">
            ...
            <Select v-model="createBrand" :options="brandData" optionLabel="name" optionValue="id" class="w-full md:w-56" @change="handleChange"  highlightOnSelect/>
          </div>
          <div class="flex items-center gap-4 mb-4">
            <label for="model" class="font-semibold w-24">Model</label>
            <Select v-model="createModel" :options="modelFiltered" optionLabel="name"  optionValue="id" class="w-full md:w-56" @change="handleVersionChange"  highlightOnSelect/>
          </div>
          <div class="flex items-center gap-4 mb-4">
            <label for="version" class="font-semibold w-24">Version</label>
            <Select v-model="createVersion" :options="versionFiltered" optionLabel="name" optionValue="id" class="w-full md:w-56" highlightOnSelect/>
          </div>
          <div>
